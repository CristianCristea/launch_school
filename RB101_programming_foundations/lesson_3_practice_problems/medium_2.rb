...
# a_string_param and an_array_param are new local variables inside the method
# String#+ returns a new string so a_string_param = is a new string inside the method
# Array#<< just adds to the object, no new object
